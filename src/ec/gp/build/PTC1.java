 ...
 * 
 ...
 <li> PTC1 has provisions for picking nonterminals with various probabilities over other nonterminals (and likewise for terminal).  To use this, tweak the PTCFunctionSetForm object.
 </ul>
 *
...
public class PTC1 extends GPNodeBuilder 
    ...
    private GPNode ptc1(final EvolutionState state,
        ...
        {
        // ptc1 can mess up if there are no available terminal for a given type.  If this occurs,
