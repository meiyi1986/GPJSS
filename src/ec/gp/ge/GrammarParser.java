...
public class GrammarParser implements Prototype
    ...
    /** 
     * Lots of stuffs to enumerate/analyze the dagp tree,
    ...
    /** Parses the rules from a dagp and returns the resulting GrammarRuleNode root. */
    ...
    /**
     * Checks that all dagp rules in ruleshashmap have at least one possible production
     * @return true if dagp rules are properly defined, false otherwise
     */
    ...
    /**
     * Run BFS to enumerate the whole dagp tree into all necessary
    ...
    /**
     * We do not have any example dagp to test with FOLLOW-SETs,
     * so the FOLLOW-SET is empty, we need to test with a dagp
     * that contains post-fix notations;
     *
     * this needs to be implemented properly with a new dagp.
     */
