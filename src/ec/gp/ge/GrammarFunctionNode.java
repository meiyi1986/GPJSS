 ...
 * is the name of the GPNode in the dagp; and the children are various arguments to the node
 * as defined by the dagp.  These are returned  by getArgument(...) and getNumArguments().
